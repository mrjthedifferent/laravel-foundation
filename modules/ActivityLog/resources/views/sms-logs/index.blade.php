...
<x-search-card>
    <div class="col-md-3 mb-2">
        <x-form.input name="search" label="Search" :value="request('search')" placeholder="Phone, message…" />
    </div>
    <div class="col-md-3 mb-2">
    ...
    <div class="col-md-3 mb-2">
        <x-form.select class="select" name="status" label="Status" :options="['' => 'All Statuses', 'success' => 'Success', 'failed' => 'Failed']" :selected="request('status')" data-placeholder="All" />
    </div>
</x-search-card>
