        ...
        <div class="table-responsive">
            <table class="table table-hover table-borderless align-middle mb-0">
                ...
                <tr>
                    ...
                    <th>{{ __('activitylog::activitylog.show.col_action_by') }}</th>
                    <th>{{ __('activitylog::activitylog.show.col_time') }}</th>
                    <th>{{ __('activitylog::activitylog.show.col_ip_url') }}</th>
                    ...
                    <tr class="align-top">
                        ...
                        <td>
                            ...
                            @elseif ($audit->event === 'updated')
                                @php $changed = $audit->old_values ?? []; @endphp
                                @if (count($changed))
                                    <dl class="fd-dl">
