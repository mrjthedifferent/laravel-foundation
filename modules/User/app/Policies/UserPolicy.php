...
class UserPolicy
{
    ...
    {
        // Can update if has permission OR updating own profile
    ...
    {
        return $user->can('Verify User Contact');
    }
     ...
     *
     * Super Admin only — by role, not a grantable permission. Super Admins
