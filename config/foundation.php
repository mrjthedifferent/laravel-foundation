...
return [
    ...
    */
    ...
    /*
    | The three role names RolePermissionDatabaseSeeder creates. Renaming them
    | here — before first seeding — is all a project needs; every role check in
    | the package reads through Mrj\Foundation\Support\Roles rather than a
    | literal. Super Admin is also load-bearing: it is the only role allowed to
    | impersonate other users (User::isSuperAdmin()).
    */
    'roles' => [
        'super_admin' => env('FOUNDATION_ROLE_SUPER_ADMIN', 'Super Admin'),
